...
from pax.agents.shaper.networks import (
...
class PPO(AgentInterface):
    ...
    def __init__(
        ...
        self.evo_batch_policy = jax.jit(
            jax.vmap(
                jax.vmap(self._policy, (None, 0, 0), (0, None, 0)),
            )
        )
        self.evo_batch_reset = jax.jit(
            jax.vmap(jax.vmap(self.reset_memory, (0, None), 0), (0, None), 0),
            static_argnums=1,
        )
