# Adapted from https://github.com/deepmind/acme/blob/master/acme/agents/jax/naive/learning.py
...
class NaiveLearner:
    ...
    def select_action(self, t: TimeStep):
        """Selects action and updates info with naive specific information"""
