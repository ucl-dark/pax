    ...
    def run_loop(self, env, agents, num_episodes, watchers):
        ...
        def _outer_rollout(carry, unused):
            ...
            a2_state, a2_memory, a2_metrics = agent2.batch_update(
                stacks[1], final_t2, a2_state, a2_memory
            )
            return (
                t1,
                t2,
        ...
        for i in range(num_episodes):
            ...
            if i % log_interval == 0:
                ...
                if self.args.render:
                    ...
                    for _i in range(env.episode_length):
                        frame = jax.tree_util.tree_map(
                            lambda x: x[_i, ...], _env_state  # noqa: B023
                        )
                        pics.append(env.render(frame))
