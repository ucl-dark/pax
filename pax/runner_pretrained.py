    ...
    def train_loop(self, env, agents, num_episodes, watchers):
        ...
        for i in range(num_episodes):
            ...
            if self.args.env_type == "coin_game":
                ...
                cum_reward_0 += rewards_0
                cum_reward_1 += rewards_1
            ...
            if i % log_interval == 0:
                ...
                print(
                    f"Cum. Reward: {cum_reward_0 / (i+1), cum_reward_1 / (i+1)}"
                )
                    ...
                    wandb.log(
                        {
                            ...
                            "train/cum_reward/player_1": cum_reward_0
                            / (i + 1),
                            "train/cum_reward/player_2": cum_reward_1
                            / (i + 1),
                        }
                        | env_stats,
                    )
