...
class DiffEvoRunner:
    ...
    def __init__(
        ...
        def _inner_rollout(carry, unused):
            ...
            # diff = jnp.abs(a1_mem[log_probs] - a2_mem[log_probs])
            # updated_log_probs_1 = jax.nn.relu(a1_mem[log_probs] - diff)
            # updated_log_probs_2 = jax.nn.relu(a2_mem[log_probs] - diff)
            # a1 = jax.random.choice(rngs, a1_mem[log_probs], shape=(args.num_envs,), p=updated_log_probs_1)
            # a2 = jax.random.choice(rngs, a2_mem[log_probs], shape=(args.num_envs,), p=updated_log_probs_2)
